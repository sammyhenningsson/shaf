...
describe Shaf::ResourceUris do
  ...
  describe "uri methods with specified plural name" do
    ...
    it "adds baz_uri method to UriHelper" do
      assert_method_registered :baz_uri
      assert_equal '/baz', UriHelper.baz_uri
    end

    it "adds baz_uri(id) method to UriHelper" do
      assert_method_registered :baz_uri
      assert_equal '/baz/5', UriHelper.baz_uri(@resrc)
    end

    it "adds new_baz_uri method to UriHelper" do
      assert_method_registered :baz_uri
      assert_equal '/baz/form', UriHelper.new_baz_uri
    end

    it "adds edit_baz_uri method to UriHelper" do
      assert_method_registered :baz_uri
